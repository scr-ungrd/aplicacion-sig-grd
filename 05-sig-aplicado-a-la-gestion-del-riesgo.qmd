...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_47369585.png)

**Figura ****25****. **Paso a paso implementación de los SIG en la GRD.
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_9e9261f1.jpeg)

**Figura ****26****.** Tecnologías geoespaciales para fenómenos amenazantes.
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_1da8dc52.png)

**Figura ****27**. Mapa conceptual esquemático de los procesos desarrollados en el conocimiento del riesgo de desastres 
...
A continuación, en las Figura 26 se evidencian el flujo de trabajo para la implementación de los SIG en los 3 subprocesos de Conocimiento del Riesgo.



![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_2b5c194b.png)

**Figura ****28****.** Flujo de trabajo de la implementación de un SIG en el subproceso de Identificación de Escenarios de Riesgo. 
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_43266377.png)

**Figura ****29****. **Mapa conceptual esquemático de los procesos desarrollados en la reducción del riesgo de desastres 
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_6cc77dbe.png)

**Figura ****30**. Flujo de trabajo en la implementación de un SIG en el proceso de reducción del riesgo.
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_da216748.png)

**Figura ****31****.** Esquema de los subprocesos relacionados con el manejo de desastres.
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_518076c1.png)

**Figura ****32****. **Flujo de trabajo en la implementación de un SIG en el proceso de manejo de desastres.
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_92610159.png)

**Figura ****33****. **Análisis multitemporal de la dinámica fluvial de un rio y su interacción con el asentamiento poblacional en su ronda hídrica. 

Fuente: SERTIT- Introducción a la percepción remota para la gestión de desastres-United Nation Office for Outer Space Affairs

**M****apa de pendientes a partir de un DEM**



![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_c72becf3.png)

**Figura ****34****. **Mapa de pendientes reclasificadas Microcuenca Quebrada Guachucal, Pasto- Nariño.
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_823f92e5.png)

**Figura ****35****.** Mapa topográfico con curvas de nivel detalladas a escala, Abrego-Norte de Santander. Fuente: 
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_9dee5a6a.png)

**Figura ****36**. Mapa de unidades geomorfológicas, Rosas-Cauca. 
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_a2d82020.png)

**Figura ****37****. **Imágenes satelitales de radar multitemporales a diversos periodos de tiempo, Sector Caregato- Mojana 
...
**Figura ****38****. **Georreferenciación de drenajes, movimientos en masa y procesos erosivos Microcuenca Quebrada Guachucal, Pasto- Nariño.
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_85e248ff.jpeg)

**Figura ****39****. **Modelamiento de huella de inundación en Bello, Antioquia.
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_f8f2640f.jpeg)

**Figura ****40****. **Modelamiento de flujo por avenida torrencial en Bello, Antioquia.
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_07ee1aff.png)

**Figura ****41****. **Mapas de expansión urbana para el municipio de Aguachica Año 2009,2010,2011.
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_af0f8219.jpeg)

**Figura ****42****. **Mapa de usos de suelos actualizado de la ciudad de Bogotá. 
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_a355c472.png)

**Figura ****43****. **Mapas de cambio de uso del suelo en la cuenca hidrográfica del Rio Magdalena para el periodo 1980-2000 derivados de la clasificación de imágenes Landsat 

Fuente: Modificado de Restrepo & Syvitski, 2006.

**Visor de emergencias viales**



![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_a9a311f8.png)

**Figura ****44****.** Central de emergencias viales de la UNGRD. 
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_85a3cc9e.png)

**Figura ****45****.** Sistema de control para la inspección de viviendas post desastre. 
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_b63318ea.png)

**Figura ****46****.** Mapa de respuesta ante un escenario de emergencia volcánica, volcán Nevado del Ruiz. 
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_1cb97237.png)

**Figura ****47****.** Visor de sitios reportados con erosión costera.
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_37a09009.png)

**Figura ****48****. **Visor de Sistemas de Alerta Temprana.
...
![](media/05-sig-aplicado-a-la-gestion-del-riesgo/img_24e01b81.png)

**Figura ****49****. **Visor de Instalaciones Industriales con potencial riesgo NATECH y tecnológico en Colombia. 
