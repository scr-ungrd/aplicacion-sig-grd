# 7. Recomendaciones generales para un SIG en GRD municipal

![Recomendaciones para un SIG municipal. Fuente: UNGRD, 2025.](media/07-recomendaciones-generales-para-un-sig-en-grd-/img_109b2fa3.png){#fig-recomendaciones-sig-municipal}

## 7.1. Enfoque interinstitucional y participativo
...
## 7.2. Fortalecimiento de capacidades técnicas
...
### 7.3. Uso de software libre y recursos gratuitos
...
### 7.4. Estandarización y calidad de datos

- Definir normas locales para el manejo de información: proyección oficial (MAGNA-SIRGAS Origen Nacional), formatos, metadatos, estructura de carpetas.
- Asegurar la calidad de la información espacial: evitar errores topológicos, inconsistencias en atributos o duplicidades.
...
- Crear manuales de usuario, listas de capas y fichas de productos cartográficos.

### 7.5. Aplicación estratégica y sostenibilidad del SIG
