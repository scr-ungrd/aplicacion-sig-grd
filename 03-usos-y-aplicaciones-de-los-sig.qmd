...
En este contexto, se utilizan dos superficies de referencia: el elipsoide, una figura matemática ideal que modela la forma general del planeta, y el geoide, una superficie equipotencial del campo gravitacional terrestre, más representativa del nivel medio del mar (Schwarz et al., 1990; IGAC, 2021). Ver @fig-tierra-geoide-elipsoide.
