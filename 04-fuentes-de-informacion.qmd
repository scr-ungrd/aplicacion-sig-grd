...
![](media/04-fuentes-de-informacion/img_fd61a985.png)

**Figura ****14****. **Tipos de imágenes: ópticas y radar. La Mojana. 
...
PlanetScope permite mediante el índice diferencial de vegetación normalizado (NDVI), generar una imagen que muestra el color verde o biomasa relativa, que aporta valores en -1.0 y 1.0, lo que permite la categorización de la cobertura vegetal. Ver Figura 15



![](media/04-fuentes-de-informacion/img_a85bf52d.png)

**Figura ****15****. **Índice diferencial de vegetación normalizado (NDVI). 
...
![](media/04-fuentes-de-informacion/img_479eff90.png)

**Figura ****16****. **Portal de descarga de imágenes satelitales de alta resolución. 
...
![](media/04-fuentes-de-informacion/img_85cfbb5c.png)

**Figura ****17****. **Geoportal Colombia en Mapas. 
...
![](media/04-fuentes-de-informacion/img_d49bee72.png)

**Figura ****18****. **Portal Colombia OT. 
...
![](media/04-fuentes-de-informacion/img_919990ae.png)

**Figura ****19****. **Consolidado de atención a emergencias
...
![](media/04-fuentes-de-informacion/img_3a8a5e7e.png)

**Figura ****20****. **Geoportal Servicio Geológico Colombiano. 
...
![](media/04-fuentes-de-informacion/img_54395714.png)

**Figura ****21****. **Geoportal IDEAM.
...
![](media/04-fuentes-de-informacion/img_f4bd2311.png)

**Figura ****22****.** Geoportal INVEMAR.
...
![](media/04-fuentes-de-informacion/img_47c55e07.png)

**Figura ****23****. **Geoportal WildFire Solution
