...
***Figura 1:**** Localización del enlace de descarga del aplicativo. ****Fuente****: *
...
![](media/anexo_24-requerimientos-de-hardware/img_ed349974.png)

***Figura 2: ****Requerimientos mínimos de Hardware para el uso del aplicativo. ****Fuente****: *



![](media/anexo_24-requerimientos-de-hardware/img_08924600.png)

***Figura 3: ****Requerimientos recomendados de Hardware para el uso del aplicativo. ****Fuente****: *
...
![](media/anexo_24-requerimientos-de-hardware/img_9f9b9891.png)

***Figura 3: ****Requerimientos de software para el uso del aplicativo. ****Fuente****: *
...
![](media/anexo_24-requerimientos-de-hardware/img_34fb98ac.png)

***Figura 4:**** Archivo descomprimido en cualquier directorio. ****Fuente: ****Autor.*
...
***Tabla 1: ****Subcarpetas contenidas dentro del aplicativo ****MagnaSirgasPro5.1****. ****Fuente: ****Autor*
...
![](media/anexo_25-interfaz-del-aplicativo/img_3d5e4260.png)

***Figura 5: ****Interfaz del aplicativo MagnaSirgasPro-5.1. ****Fuente: ****IGAC.*
...
![](media/anexo_25-interfaz-del-aplicativo/img_8df92762.png)

***Figura 6: ****Interfaz de las herramientas del menú Conversión y Transformación. ****Fuente: ****IGAC.*
...
![](media/anexo_25-interfaz-del-aplicativo/img_c641d393.png)

***Figura 7: ****Interfaz de las herramientas del menú Ondulación Geoidal. ****Fuente: ****IGAC.*
...
![](media/anexo_25-interfaz-del-aplicativo/img_cb55d8ff.png)

***Figura 8: ****Interfaz de las herramientas del menú Nivelación GPS. ****Fuente: ****IGAC.*
...
![](media/anexo_25-interfaz-del-aplicativo/img_6dc3a9ba.png)

***Figura 9: ****Interfaz de las herramientas del menú Cálculos elipsoidales. ****Fuente: ****IGAC.*
...
![](media/anexo_25-interfaz-del-aplicativo/img_4033fa6c.png)

***Figura 10: ****Interfaz de las herramientas del menú Cálculo Velocidades. ****Fuente: ****IGAC. *
...
![](media/anexo_25-interfaz-del-aplicativo/img_946d8ef7.png)

***Figura 11: ****Interfaz de las herramientas del menú Cambio de Época. ****Fuente: ****IGAC.*
...
![](media/anexo_25-interfaz-del-aplicativo/img_5741d219.png)

***Figura 12: ****Interfaz de la herramienta Configuración. ****Fuente: ****IGAC.*
...
![](media/anexo_26-conversion-y-transformacion/img_8e5891b8.png)

***Figura 13: ****Configuración del sistema de referencia de partida. ****Fuente: ****IGAC.*
...
![](media/anexo_26-conversion-y-transformacion/img_f127e9af.png)

***     Figura 14:**** Magna Sirgas. ****Fuente: ****IGAC.****Figura 15: ****Datum Bogotá. ****Fuente: ****IGAC..*



![](media/anexo_26-conversion-y-transformacion/img_431930d0.png)

***Figura 16: ****Asignación de nombre y secuencia al punto calculado. ****Fuente: ****IGAC..*
...
![](media/anexo_26-conversion-y-transformacion/img_7259686b.png)

***Figura 17: ****Configuración del nombre de punto calculado según el ejemplo. ****Fuente: ****IGAC.*



![](media/anexo_26-conversion-y-transformacion/img_9b18af57.png)

***Figura 17: ****Ingreso de coordenadas iniciales o de partida, sobre las cuales se desea hacer una conversión o transformación. ****Fuente: ****IGAC.*
...
![](media/anexo_26-conversion-y-transformacion/img_6a349aad.png)

***Figura 17: ****Ingreso de coordenadas iniciales. ****Fuente: ****IGAC.*



![](media/anexo_26-conversion-y-transformacion/img_e7db93ad.png)

***Figura 18****: Especificaciones de coordenadas de salida (Origen de coordenadas). ****Fuente: ****IGAC.*
...
![](media/anexo_26-conversion-y-transformacion/img_21f175b4.png)

***Figura 19****: Ejecución del comando calcular y procesamiento. ****Fuente: ****IGAC.*
...
![](media/anexo_26-conversion-y-transformacion/img_df973826.png)

***Figura 20****: Coordenadas resultantes y localización geográfica. ****Fuente: ****IGAC.*
...
![](media/anexo_26-conversion-y-transformacion/img_b3f82884.png)

***Figura 21****: Conversión a coordenadas plano-cartesianas. ****Fuente: ****IGAC.*
...
![](media/anexo_26-conversion-y-transformacion/img_a8dfd727.png)

***Figura 22: ****Configuración del sistema de referencia de partida para el cálculo de coordenadas mediante archivo. ****Fuente: ****IGAC.*
...
![](media/anexo_26-conversion-y-transformacion/img_6d374060.png)

***Figura 23: ****Configuración de la extensión del tipo de archivo de entrada y cargue en el aplicativo. ****Fuente: ****IGAC.*
...
![](media/anexo_26-conversion-y-transformacion/img_877adc02.png)

***Figura 24: ****Diligenciamiento del archivo de entrada en formato excel. ****Fuente:Autor***
...
![](media/anexo_26-conversion-y-transformacion/img_48cbbb5b.png)

***Figura 25: ****Configuración del archivo de entrada. ****Fuente: ****IGAC..*
...
![](media/anexo_26-conversion-y-transformacion/img_c9206dd1.png)

***Figura 26: ****Configuración del encabezado del archivo cargado y su nomenclatura. ****Fuente: ****IGAC.*
...
![](media/anexo_26-conversion-y-transformacion/img_6d3dda8f.png)

***Figura 26: ****Configuración del sistema de coordenadas de partida y vinculación de casillas  . ****Fuente: ****IGAC.*
...
![](media/anexo_26-conversion-y-transformacion/img_8aebacaf.png)

***Figura 27: ****Lista desplegable de encabezados a relacionar. ****Fuente: ****IGAC.*



![](media/anexo_26-conversion-y-transformacion/img_ef0da363.png)

***Figura 28: ****Diligenciamiento de pasos para la obtención de coordenadas de salida. ****Fuente: ****IGAC.*
