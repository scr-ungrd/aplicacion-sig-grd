...
Los SIG son conjuntos de herramientas integradas para capturar, almacenar, consultar, analizar y desplegar datos geoespaciales (Chang, 2008; Longley et al., 2015). Los SIG son el núcleo de la tecnología geoespacial, que está relacionada con una serie de campos como la teledetección, Sistema de Posicionamiento Global (GPS), cartografía, topografía, geoestadística, programación, gestión de bases de datos y diseño gráfico (Heywood et al., 2011; Burrough & McDonnell, 1998). Estas herramientas permiten combinar información gráfica y alfanumérica para generar productos como mapas, visores, modelaciones y bases de datos (Esri, 2013).
